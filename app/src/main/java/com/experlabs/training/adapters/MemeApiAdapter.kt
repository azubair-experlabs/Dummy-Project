...
import com.experlabs.training.databinding.MemeApiItemBinding
...
class MemeAdapter(private val memes: List<Meme>, val adapterOnClick : (Meme) -> Unit) : RecyclerView.Adapter<MemeAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding : MemeApiItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item : Meme){
     ...
     override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
         ...
         val itembinding = MemeApiItemBinding.inflate(inflater, viewGroup, false)
